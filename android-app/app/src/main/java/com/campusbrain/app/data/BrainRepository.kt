    ...
    companion object {
        ...
        fun init(context: Context, embedder: QueryEmbedder? = null) {
            ...
            _state.value = try {
                ...
                val vectors = com.campusbrain.app.retrieval.VectorSearch(db)
                ...
                val userArms = userDb?.let {
                    HybridSearch.UserArms(
                        ...
                        vectors = com.campusbrain.app.retrieval.VectorSearch(it.conn, db.embeddingDim),
                        conn = it.conn,
                    )
                }
                ...
                val router = QueryRouter(db, hybrid, tabular, graph, prototypes,
                    cloud = com.campusbrain.app.answer.CloudAnswer(context))
