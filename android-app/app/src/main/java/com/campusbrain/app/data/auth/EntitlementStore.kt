 ...
 *
 * [com.campusbrain.app.data.BrainDb] re-copies `brain.db` out of the APK
 ...
 * an EXCLUSIVE lock, and [com.campusbrain.app.data.UserCorpusDb.write] wraps
...
class EntitlementStore(private val conn: SQLiteConnection) {
     ...
     * belongs to [com.campusbrain.app.data.UserCorpusDb], which owns the
