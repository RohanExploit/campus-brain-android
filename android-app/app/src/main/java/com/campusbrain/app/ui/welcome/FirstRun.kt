 ...
 * [com.campusbrain.app.data.auth.EntitlementStore], which is the precedent
...
object FirstRun {
     ...
     * [com.campusbrain.app.ui.auth.EnrolCopy] uses.
     */
 ...
 *
 * Not `brain.db`: [com.campusbrain.app.data.BrainDb] re-copies that file out
 ...
 *
 * The locking rules are [com.campusbrain.app.data.auth.EntitlementStore]'s
 ...
 * [com.campusbrain.app.data.auth.EntitlementStore.PRAGMA_BUSY_TIMEOUT], and
