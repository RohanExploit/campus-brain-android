...
import com.kriet.campusbrain.data.AnalyticsStore
import com.kriet.campusbrain.data.QueryLog
...
object Licensing {
     ...
     *    consulted by [com.kriet.campusbrain.data.DocumentIngest.ingest] and
     ...
     * [com.kriet.campusbrain.data.DocumentIngest] for why that is a promise and
     * not an oversight.
     */
    ...
    fun minutesAssumption(): Map<com.kriet.campusbrain.data.Route, Int> =
        analytics?.minutes() ?: AnalyticsStore.DEFAULT_MINUTES

    fun setMinutesAssumption(route: com.kriet.campusbrain.data.Route, minutes: Int): Boolean =
